...
class AllKinds {
   public:
    ...
    double sumMember2WithMember3() const {
        return member2_ + member3_;  // long promoted to double, float promoted to double
    }
...
int main() {
    ...
    std::cout << "Sums: " << obj1.sumMember1WithMember2() << ", " << obj1.sumMember1WithMember3()
              << ", " << obj1.sumMember2WithMember3() << "\n\n";

    // Custom initialization
    AllKinds obj2(5, 2000L, 3.14f);
    std::cout << "Custom initialization:\n";
    std::cout << "Sums: " << obj2.sumMember1WithMember2() << ", " << obj2.sumMember1WithMember3()
    ...
    std::cout << "Edge cases:\n";
    std::cout << "Sums: " << obj3.sumMember1WithMember2() << ", " << obj3.sumMember1WithMember3()
              << ", " << obj3.sumMember2WithMember3() << "\n\n";

    // Negative values
    AllKinds obj4(-1, -100L, -0.5f);
    std::cout << "Negative values:\n";
    std::cout << "Sums: " << obj4.sumMember1WithMember2() << ", " << obj4.sumMember1WithMember3()
