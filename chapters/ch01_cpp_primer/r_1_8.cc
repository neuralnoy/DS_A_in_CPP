// R-1.8 Write a short C++ function, isMultiple, that takes two positive long
// values, n and m, and returns true if and only if n is a multiple of m, that
// is, n = mi for some integer i.
