...
int main() {
    ...
    std::cout << "Distinct vector check: " << ContainsDistinctValues(test_vector_distinct) << "\n";

    std::cout << "Non-distinct vector check: " << ContainsDistinctValues(test_vector_not_distinct)
              << "\n";
