...
template <typename E> SLinkedList<E>::SLinkedList() : head(nullptr), n(0) {}
...
template <typename E> bool SLinkedList<E>::empty() const { return n == 0; }

template <typename E> int SLinkedList<E>::size() const { return n; }
